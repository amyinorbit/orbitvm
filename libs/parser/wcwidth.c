// Amy Parent (2017-05-24): Change codepoint_t to codepoint_t (int32_t)
//                          Change to explicit sized types
/*
 ...
 *
 * This implementation assumes that codepoint_t characters are encoded
 * in ISO 10646.
 */

int mk_wcwidth(codepoint_t ucs)
{
  unsigned long cmp = (int32_t) ucs;
...
int mk_wcswidth(const codepoint_t *pwcs, uint64_t n)
{
  int width = 0;
 ...
 */
int mk_wcwidth_cjk(codepoint_t ucs)
{
...
int mk_wcswidth_cjk(const codepoint_t *pwcs, uint64_t n)
{
  int width = 0;
